...
void printTable(const Student *students, int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        cout << "| " << setw(2) << right << i + 1 << " "
             ...
             << "| " << setw(11) << right << students[i].informaticsGrade << " |" << endl;
    }
    cout << "======================================================================================="
         << endl;
    cout << endl;
...
void sortStudents(Student *students, const int N, int *indexArray)
{
    ...
    for (int i0 = 0; i0 < N - 1; i0++) 
        for (int i1 = 0; i1 < N - i0 - 1; i1++)
            if ((students[i1].specialty > students[i1 + 1].specialty) ||
                (students[i1].specialty == students[i1 + 1].specialty &&
                 students[i1].course > students[i1 + 1].course) ||
                (students[i1].specialty == students[i1 + 1].specialty &&
                 students[i1].course == students[i1 + 1].course &&
                 students[i1].lastName > students[i1 + 1].lastName))
...
{ 
    ...
    for (int i = 0; i < numberOfStudents; i++)
    {
        ...
        cout << "| " << setw(9) << left << students[I[i]].lastName
             ...
             << "| " << setw(11) << right << students[I[i]].informaticsGrade << " |" << endl;
    }
    cout << "======================================================================================"
         << endl;
    cout << endl;
